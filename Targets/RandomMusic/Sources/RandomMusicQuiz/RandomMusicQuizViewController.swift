...
public final class RandomMusicQuizViewController: UIViewController, View {
  private let content = RandomQuizView()

  public init(reactor: RandomMusicQuizReactor) {
  ...
  public func bind(reactor: RandomMusicQuizReactor) {
